...
export const categories = [
    ...
    { name: 'Music', icon: < MusicNoteIcon className = 'PNG' / > },
    { name: 'Education', icon: < SchoolIcon className = 'PNG' / > , },
    { name: 'Podcast', icon: < GraphicEqIcon className = 'PNG' / > , },
    { name: 'Movie', icon: < OndemandVideoIcon className = 'PNG' / > , },
...
export const demoVideoUrl = 'https://youtu.be/E4lb2gkyXr8';
export const demoChannelTitle = 'CS50';
export const demoVideoTitle = 'Structures - CS50 Shorts';
export const demoProfilePicture = 'https://yt3.ggpht.com/ytc/AMLnZu_8E2fVaNH2D20xn32ph9axohUCgWaLpXO_tXJ14g=s88-c-k-c0x00ffffff-no-rj';